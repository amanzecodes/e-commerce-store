...
//     try {
//       const newCoupon = new Coupon({ code, discount, expiryDate, isActive });
...
//       return res.status(400).json({ success: false, message: 'Coupon already used by this buyer' });
//     }
...
//   try {
//     const updatedCoupon = await Coupon.findByIdAndUpdate(id, { code, discount, expiryDate, isActive }, { new: true });
